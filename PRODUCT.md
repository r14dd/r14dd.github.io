...
## Users
Recruiters, hiring managers, and engineering peers evaluating Riad Mukhtarov for AI/software engineering roles. They arrive from LinkedIn, GitHub, or a shared link. Recruiters scan quickly for credibility signals; engineers linger on craft details and technical depth. Both need to leave knowing what Riad builds, how he thinks, and that the execution is sharp.
...
## Anti-references
- **Generic dev templates**: cookie-cutter dark themes with gradient cards, 01/02/03 numbered sections, identical card grids, "Hi, I'm X" hero with waving hand emoji
- **Overly flashy / 3D heavy**: Bruno Simon-style WebGL spectacles that prioritize wow factor over substance. No Three.js for the sake of Three.js
- **Corporate / enterprise**: safe, inoffensive, could-be-anyone design with stock imagery and blue CTA buttons. Nothing that looks like it was built by a committee
...
- Keyboard navigable throughout (command palette, shortcuts overlay)
- Screen reader compatible with semantic HTML and ARIA labels
- i18n support for English, Russian, and Azerbaijani
