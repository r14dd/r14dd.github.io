  ...
  en: {
    ...
    labels: {
      ...
      timeGreetings: {
        ...
        evening: 'Good evening from Baku',
        night: 'Burning the midnight oil in Baku',
      },
      ...
      skillCategories: {
        ...
        'Protocols, APIs & Messaging': 'Protocols, APIs & Messaging',
  ...
  ru: {
    ...
    projects: translateProjects({
      patent: {
        ...
        badges: [
          {
            api: 'https://api.github.com/repos/r14dd/patent',
            pillLabel: 'звёзд',
            platform: 'на GitHub',
            link: 'https://github.com/r14dd/patent',
          },
          {
            api: 'https://crates.io/api/v1/crates/patent',
            pillLabel: 'загрузок',
            platform: 'на crates.io',
            link: 'https://crates.io/crates/patent',
          },
        ],
      },
      quorumrag: {
    ...
    labels: {
      ...
      timeGreetings: {
        ...
        evening: 'Добрый вечер из Баку',
        night: 'Ночной код из Баку',
      },
      ...
      skillCategories: {
        ...
        'Protocols, APIs & Messaging': 'Протоколы, API и очереди сообщений',
  ...
  az: {
    ...
    testimonials: [
      ...
      },
      {
        ...
        quote:
          'O, təkcə materialın texniki tərəfini dərindən başa düşməklə kifayətlənmədi, həm də bu anlayışları çətinlik çəkən tələbələrə sadə şəkildə izah edə bildi.',
        linkedin: 'https://www.linkedin.com/in/jesse-hartloff-a8309212/',
      },
      {
        name: 'Carl Alphonce',
        ...
        quote:
          'O, sorğulara operativ cavab verirdi, tələbələr və kurs heyəti ilə peşəkar davranırdı və kursdakı bütün alətlər və proseslərdə texniki bacarıq nümayiş etdirirdi.',
        linkedin: 'https://www.linkedin.com/in/carl-alphonce-9b7b323/',
      },
      {
        name: 'Nasrin Akhter',
        ...
        quote:
          'Onun güclü iş etikası, müsbət münasibəti, peşəkarlığı və fədakarlığı məni heyran etdi. O, mütəşəkkil, səmərəli və zəhmətkeş bir assistent olduğunu sübut etdi.',
        linkedin: 'https://www.linkedin.com/in/nasrinakhter/',
      },
      {
        name: 'Sean Mackay',
        ...
        quote:
          'Riad əməkdaşlıq etdiyim ən yaxşı insanlardan biridir. Mürəkkəb anlayışları müxtəlif bacarıq səviyyələrinə sadə şəkildə çatdırmaq qabiliyyəti məni daima heyran edirdi.',
        linkedin: 'https://www.linkedin.com/in/sean-mackay-phd-784905140/',
      },
      {
        name: 'Farshad Ghanei',
        ...
        quote:
          'Riadın iş etikasını, bacarıqlarını, nəticələrini və ünsiyyət qabiliyyətini təsdiq edirəm. Onu istənilən işəgötürənə tövsiyə etməkdə tərəddüd etmirəm.',
        linkedin: 'https://www.linkedin.com/in/farshad-ghanei/',
      },
    ],
    labels: {
      ...
      timeGreetings: {
        ...
        evening: 'Bakıdan axşamınız xeyir',
        night: 'Bakıda gecə kodlaşma',
      },
      ...
      skillCategories: {
        ...
        'Protocols, APIs & Messaging': 'Protokollar, API və Mesajlaşma',
